<?php echo $header; ?>
    ...
    <div id="dialog-box">
        <div class="dialog-content">
            <div id="dialog-message">Type the name of the sender</div>
            <div id="dialog-textbox"><input type="text" id="add_from" name="add_from" value="" /></div>
            <a id="button-send-name"  class="button">Add</a>
            <div id="dialog-message-email">Type the email address of the sender</div>
            <div id="dialog-textbox-email"><input type="text" id="add_email" name="add_email" value="" /></div>
            <a id="button-send-email"  class="button">Add Email</a>
        </div>
    </div>
       <div id="content">
    ...
    <div class="content">
        ...
        <table id="mail" class="form">
          <tr>
            ...
            <td><select id="from" name="from">
                <?php foreach ($store_name as $store) { ?>
            ...
            <span id="addfrom">
                  <img src="../image/data/add.gif"alt="Add a name to send from  ex.' <?php echo $store_name[0]; ?> Newsletter ' ">
                  <br>
                  Add a name to send from  ex.' <?php echo $store_name[0]; ?> Newsletter '
                  </span>
            </td>
          </tr>
           <tr>
            <td><?php echo $entry_from; 
                ?></td>
            <td><select id="sender_email" name="sender_email">
                    
                <option value="<?php echo $store_email; ?>"><?php echo $store_email; ?></option>
               
                <?php
              
               foreach($senderemails as $senderemail) { 
                ?>
                <option value="<?php echo $senderemail['value']; ?>"><?php echo $senderemail['value']; ?></option>
                <?php
                }
                ...
                ?>
                 ...
                 <span id="addemail">
                  <img src="../image/data/add.gif"alt="Add a name to send from  ex.' <?php echo $store_email; ?> Newsletter ' ">
                  <br>
                  Add a email address to send from  ex.' <?php echo $store_email; ?>  '
                  </span>
            </td>   
          </tr>
          <tr>
        ...
        foreach ($lists as $list) {
         ?>
          ...
          <td>Send As:</td>
           <td>
             HTML <input name="sendformat" value="html" checked="" type="radio">
             <?php echo $entry_text; ?> <input name="sendformat" value="text"  type="radio">
            </td>
            </tr>
          <tr>
          <td>Delay Sending Until</td>
          <td><input id="embargo" type="text" name="embargo" value="" /></td>
           </tr>
          <tr>
          <td>email to alert when sending of this message starts</td>
          <td><input id="emailalertstart" type="text" name="emailalertstart" value="" /></td>
           </tr>
          <tr>
          <td>email to alert when sending of this message ends</td>
          <td><input id="emailalertend" type="text" name="emailalertend" value="" /></td>
           </tr>
          <tr>
